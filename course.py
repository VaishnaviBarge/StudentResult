...
class CourseClass:
    def __init__(self,root):
        ...
        #=====title=====
        title=Label(self.root,text="Course Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=35)
        ...
        txt_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,"bold"),bg='lightblue').place(x=150,y=100,width=200)
        txt_charges=Entry(self.root,textvariable=self.var_charges,font=("goudy old style",15,"bold"),bg='lightblue').place(x=150,y=140,width=200)
        ...
        lbl_search_courseName=Label(self.root,text="Search Course",font=("goudy old style",15,"bold"),bg='white').place(x=720,y=60)
        txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,"bold"),bg='lightblue').place(x=850,y=60,width=180)
            ...
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Course deleted sussesfully",parent=self.root)
                        self.clear()
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Course Added Sussessfully",parent=self.root)
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to{str(ex)}")
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Course Updated Sussessfully",parent=self.root)
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to{str(ex)}")
